...
const DashboardPage = () => {
        ...
        {recentActivity.map((activity) => (
          ...
          >
            <div className="flex items-center">
              <div
                className={`w-3 h-3 rounded-full mr-3 ${activity.status === "present" ? "bg-green-500" : "bg-red-500"
                  }`}
              ></div>
              <div>
  ...
  const navigationItems = [
    ...
    { id: "courses", label: "Courses", icon: TrendingUpIcon },
      ...
      {navigationItems.map((item) => {
        ...
        return (
          <button
            ...
            className={`w-full flex items-center px-4 py-3 text-left hover:bg-gray-100 transition-colors ${activeTab === item.id
